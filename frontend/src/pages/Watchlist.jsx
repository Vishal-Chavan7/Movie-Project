...
function Watchlist() {
  return (
    <div>
      <h1 className="text-3xl font-bold text-yellow-400 text-center mt-10">Your Watchlist</h1>
    </div>
  )
}
...
//       try {
//         const res = await axios.get(`${import.meta.env.VITE_BACKEND_API_URL}/watchlist`, { withCredentials: true });
